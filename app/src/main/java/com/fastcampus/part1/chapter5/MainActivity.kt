package com.fastcampus.part1.chapter5
...
import com.fastcampus.part1.chapter5.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun operatorClicked(view: View) {
        ...
        if (operatorText.isNotEmpty()) {
            Toast.makeText(this, "연산자는 1개만 입력 가능합니다.", Toast.LENGTH_SHORT).show()
            return
        }
